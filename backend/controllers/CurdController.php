...
class CurdController extends MController
{
    ...
    public function actions()
    {
        return [
            'index' => [
                'class' => 'jayfir\basics\backend\actions\IndexAction',
            ...
            'edit' => [
                'class' => 'jayfir\basics\backend\actions\EditAction',
                'modelClass' => $this->modelClass,
                'columns' => $this->editColumns,
            ],
            'ajax-update' => [
                'class' => 'jayfir\basics\backend\actions\AjaxUpdateAction',
                'modelClass' => $this->modelClass,
            ],
            'delete' => [
                'class' => 'jayfir\basics\backend\actions\DeleteAction',
                'modelClass' => $this->modelClass,
            ],
        ];
    }
