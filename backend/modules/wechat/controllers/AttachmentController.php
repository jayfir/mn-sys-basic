...
use jayfir\basics\common\models\wechat\Attachment;
use jayfir\basics\common\models\wechat\News;
use jayfir\basics\backend\modules\wechat\models\NewsPreview;
