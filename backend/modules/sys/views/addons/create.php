                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <?= $form->field($model, 'wechat_message')->checkboxList(\jayfir\basics\common\models\wechat\Account::$mtype)->hint('当前模块能够直接处理的消息类型(没有上下文的对话语境, 能直接处理消息并返回数据). 如果公众平台传递过来的消息类型不在设定的类型列表中, 那么系统将不会把此消息路由至此模块')?>
