...
use yii\helpers\Url;
use jayfir\basics\backend\widgets\notify\NotifyWidget;
...
<html lang="<?= Yii::$app->language ?>">
    <head>
        ...
        <?= Html::cssFile('/resource/backend/css/style.css?v=4.1.5'); ?>
    </head>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <?= \jayfir\basics\backend\widgets\menu\MenuLeftWidget::widget() ?>
                    </ul>
                </div>
            </nav>
            <!--左侧导航结束-->
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="row content-tabs">
                    <?php if (Yii::$app->config->info('SYS_MENU_TAB') == true) { ?>
                        ...
                        <nav class="page-tabs J_menuTabs">
                            <div class="page-tabs-content">
                                <a href="javascript:;" class="active J_menuTab"   data-id="index_v1.html" title="双击刷新" >首页</a>                                
                            </div>
                        </nav>
                        <button class="roll-nav roll-right J_tabRight"><i class="fa fa-forward"></i></button>

                        <div class="context-menu dropdown-menu J_onContextMenu" style="display: none; left: 220px; top: 109px;">
                            <ul role="menu" class="">
                                <li class="J_tabCloseThis"><a>关闭</a></li>
                    ...
                    <?php } ?>
                    <a href="<?= Url::to(['site/logout']) ?>" data-method="post" class="roll-nav roll-right J_tabExit"> 退出 <i class="fa fa fa-sign-out"></i></a>
                </div>
                <!--iframe 加载界面 开始-->
                <div class="row J_mainContent" id="content-main">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?= Url::to(['main/system']) ?>" frameborder="0" id="iframe_index_v1.html" data-id="index_v1.html" seamless></iframe>
                </div>
                <!--iframe 加载界面结束-->
                <div class="footer">
